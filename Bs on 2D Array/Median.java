...
public class Median {
    ...
    // Optimal Approach TC: O(log(109)) X O(M(logN)) SC: O(1)
    public static int medianOptimalApproach(int[][] matrix, int m, int n) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The median element is: " + medianOptimalApproach(matrix, m, n));
    }
